# WF-Guard — Reference Code and Resources

Reference links provided for the capstone. Safe to keep in a public repository.
...
- Pre-collected or course-specific dataset links that should not be public are listed in **NOT_IN_REPO.txt** (do not commit that file to a public repo).
